...
class AJAlertController: UIViewController {
    ...
    private var strAlertTitle = "UeBook"
    private var strAlertText = String()
    private var btnCancelTitle:String?
    private var btnOtherTitle:String?
    
    private let btnOtherColor  = UIColor.black //UIColor.init(rgb: 0x268505) //UIColor(red: 0/255.0, green: 120.0/255.0, blue: 108.0/255.0, alpha: 1.0)
    private let btnCancelColor = UIColor.black//UIColor.init(rgb: 0x268505) //UIColor(red: 255.0/255.0, green: 0.0/255.0, blue: 0.0/255.0, alpha: 1.0)
    ...
    private func setupAJAlertController(){
        ...
        lblAlertText?.font = UIFont.systemFont(ofSize: 14)
